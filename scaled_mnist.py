...
transform=torchvision.transforms.Compose([torchvision.transforms.RandomRotation(180),\
                                          ...
                                          torchvision.transforms.Normalize((0.1307,), (0.3081,))])
train_data_rot = torchvision.datasets.MNIST('MNIST/', train=True, download=True,transform=transform)
test_data_rot = torchvision.datasets.MNIST('MNIST/', train=False, download=True,transform=transform)

train_loader_rot = torch.utils.data.DataLoader(train_data_rot ,batch_size=batch_size_train, shuffle=True)
...
for epoch in range(10):
    ...
    train(model, train_loader_rot, epoch)
